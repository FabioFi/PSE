...
HD_PWD='C:/Users/fabio.fiorio/OneDrive - EXOR INTERNATIONAL SPA/Documents/PERSONAL/Univr/PSE/Elaborato/PSE/HLS_model/xtea_RTL_logic_synthesis/xtea_RTL_logic_synthesis.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log XTEA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source XTEA.tcl -notrace
